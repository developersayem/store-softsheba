        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-12 mt-7 mb-14">
            <div className="flex gap-4">
              <div className="px-10 py-10 bg-gray-500">
                ...
                <div className="flex">
                  {
                    ...
                    [1, 2, 3, 4, 5].map((s) => (
                      <FaStar key={s} className="text-[#2EA3F2]" />
                    ))
                  }
                </div>
                <div className="mt-1">
                  <h3 className="text-[#767676] text-sm font-semibold">
                    Name{" "}
                    <span className="italic font-normal">(verified owner)</span>{" "}
                    - <span className="font-normal">February 5, 2025</span>
                  </h3>
                  <p className="mt-1 text-[#666666] text-sm">
                    Business Pro has really helped my business. It is very easy
                    to use and has smart tools that make my WhatsApp marketing
                    better. The support team is kind and quick to help. I really
                    recommend it!
                  </p>
                </div>
              </div>
