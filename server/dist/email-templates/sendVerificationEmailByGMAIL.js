...
exports.sendVerificationEmailByGMAIL = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config({});
const sendVerificationEmailByGMAIL = async (to, code) => {
...
exports.sendVerificationEmailByGMAIL = sendVerificationEmailByGMAIL;
