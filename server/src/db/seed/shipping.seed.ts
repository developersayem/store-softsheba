import { ShippingRule } from "../../models/shipping_rule.model";

export const seedShippingRules = async () => {
  const existing = await ShippingRule.find().lean();
  ...
  await ShippingRule.insertMany(rulesWithStoreId);
